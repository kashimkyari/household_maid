...
if($id !=""){
 $user_edit=mysqli_query($conn,"SELECT * FROM accounts WHERE id='$id' LIMIT 1 ");
    ...
    header('Location: maid_profiles.php');
}
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    $sql="UPDATE profiles SET fname='$fname',lname='$lname',category='$category',age='$age',gender='$gender',testimonials='$testimonials',photo='$photo',status='$status' WHERE id='$id' ";
