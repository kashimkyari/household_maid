...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        if(isset($_POST['submit'])){
                            ...
                            $sql="INSERT INTO maid_profiles(category,training,status) VALUES ('$category','$training','$status')";
        ...
        <div class="row">
            <div class="col-lg-4">
                <a href="addmaid_profiles.php" type="button" class="btn btn-success">Create New +</a>
            </div> </div><br/>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-condensed table-hover dataTables" id="dataTables-libraryList">
                        ...
                        <td style="width: 150px;">
                            <a class="btn btn-sm btn-info" href="edit_maid_profile?user_id=<?php echo $row['id'];  ?>">Update</a>
