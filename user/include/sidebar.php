        ...
        <section class="sidebar">
          <ul class="sidebar-menu" >
            ...
            <li class="<?php if($page_link != '' && $page_link == 'index'){echo 'active';}?>">
              ...
              <li class="<?php if($page_link != '' && $page_link == 'maidprofile'){echo 'active';}?>"><a href="maidprofile"><i class="fa fa-users"></i> View maids Profile</a></li>
...
<!--       </li>-->
            ...
            <!--<li class="treeview <?php if($page_link != '' && $page_link == 'adminacc'){echo 'active';}?> ">
              ...
              <ul class="treeview-menu ">
              <li class="<?php if($page_link != '' && $page_link == 'maidprofile'){echo 'active';}?>"><a href="maidprofile"><i class="fa fa-circle-o"></i> View maids Profile</a></li>
                </ul>
            </li>-->
