...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">maids' Updated Profile</div>
            <div class="panel-body">
                ...
                if(isset($_POST['submit'])){
                    ...
                    $sql="INSERT INTO profiles(fname,lname,category,age,gender,testimonials,photo,status) VALUES ('$fname','$lname','$category','$age','$gender','$testimonials','$photo','$status')";
