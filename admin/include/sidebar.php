        ...
        <section class="sidebar">
          <ul class="sidebar-menu" >
            ...
            <li class="<?php if($page_link != '' && $page_link == 'index'){echo 'active';}?>">
              ...
              <li class="treeview <?php if($page_link != '' && $page_link == 'admin_accounts' || $page_link == 'management' ||$page_link == 'maid_profiles' ||$page_link == 'gallery' || $page_link == 'sliders'){echo 'active';}?> ">
              <a href="#">
                <i class="fa fa-cog"></i>
              ...
              <ul class="treeview-menu ">
                        ...
                        <!--<li class="<?php if($page_link != '' && $page_link == 'management'){echo 'active';}?>"><a href="management"><i class="fa fa-circle-o"></i> Management Profiles</a></li>-->
                         <li class="<?php if($page_link != '' && $page_link == 'maid_profiles'){echo 'active';}?>"><a href="maid_profiles"><i class="fa fa-users"></i> maid Profiles</a></li>
