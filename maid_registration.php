...
?>
    ...
    <section class="main-container col1-layout">
        <p style="text-align: center; font-size: medium;">Feel free to fill the form below with your correct personal details if in need of a job as a house maid.</br>
                ...
                <div class="col-md-8">
                    <div class="col-main">
                        <div class="panel panel-info">
                            <div class="panel-heading" style="text-align: center; color: black;">maid REGISTRATION FORM</div>
                            <div class="panel-body">
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    $sql="INSERT INTO maids_registration_details(fname,lname,id_number,email,phone,town,gender,edu_level,skills) VALUES('$fname','$lname','$id_number','$email','$phone','$town','$gender','$edu_level','$skills')";
                                ...
                                <form  id="register" method="post" action="">
                                        <!--<div class="col-xs-12">
                                            <div class="check-title">
                                                <h4 style="text-align: center;">maid Registration Form</h4>
                                            </div>
                                        </div>-->
                                        <div class="row">
                                            <div class="col-sm-6">
