...
<footer style="background-color: grey;">
            ...
            <div class="footer-newsletter">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-5">
                            <h3 class="">FOLLOW OUR SOCIALS..</h3>
                            <span> </span>
                        </div>
    ...
    <div class="footer-coppyright">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-xs-12 coppyright">  &copy;<?php echo date('Y'); ?> HOUSEHOLD MAID. Designed By <strong> Aisha Abba</strong></div>
...
<div id="jtv-mobile-menu" class="jtv-mobile-menu">
    <ul>
        ...
        <li><a href="maid_registration">maids's Register Here</a></li>
