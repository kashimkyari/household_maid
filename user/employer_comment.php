                ...
                <div class="col-md-6">
                    <div class="panel-group" id="accordion1">
                        <div class="panel panel-info">
                            ...
                            <p>Kindly provide your feedback on the quality of services our house maids provides.
                            Your feedback will be used to improve on the trainings we provide to our maids to ensure that your needs are all met.
                            </p>
                                <?php
                                if(isset($_POST['send'])){
                                $message=$_POST['message'];
                                $status="Inactive";
                                $query=$conn->query("INSERT INTO employer_feedback(fname,lname,message,status) VALUES ('$fname','$lname','$message','$status')");
                                    if($query){
